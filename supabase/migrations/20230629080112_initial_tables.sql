...
CREATE OR REPLACE FUNCTION public.insert_country_flag_url()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE TRIGGER insert_country_flag_url BEFORE INSERT ON public.countries FOR EACH ROW EXECUTE FUNCTION insert_country_flag_url();
